...
function extractVideoStream(metadata: ffmpeg.FfprobeData): FfprobeStream | undefined {
    return metadata.streams.find((s: FfprobeStream) => s.codec_type === 'video');
}
...
export async function getVideoInfo(filePath: string, logger: LogWrapper): Promise<VideoInfo> {
    try {
