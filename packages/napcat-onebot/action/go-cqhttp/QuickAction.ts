...
const QuickActionSchema = Type.Object({
  ...
  ban_duration: Type.Optional(Type.Integer({ description: '禁言时长' })),
...
const QuickActionEventSchema = Type.Object({
  time: Type.Integer({ description: '事件发生时间' }),
  ...
  message_id: Type.Optional(Type.Integer({ description: '消息 ID' })),
  message_seq: Type.Optional(Type.Integer({ description: '消息序列号' })),
  real_id: Type.Optional(Type.Integer({ description: '真实消息 ID' })),
  ...
  font: Type.Optional(Type.Integer({ description: '字体' })),
